...
BEGIN
  ...
  INSERT INTO public.orders (
    ...
    p_shipping::text, v_payment_method, 'pending'::order_status, 'BDT', v_estimated_delivery
  )
  ...
  VALUES (
    ...
    'Your order ' || v_order_number || ' has been received. Total: ' || v_total::text || ' BDT. Payment method: ' || v_payment_method || '. Estimated delivery: ' || to_char(v_estimated_delivery, 'Mon DD, YYYY') || '.',
    'pending'
  );
